...
const Langues = (() => {
  ...
  const D = {
    ...
    "sante.coupeCircuit": { fr: "Coupe-circuit", en: "Circuit breaker", sq: "Ndërprerësi" },
    "sante.jev":         { fr: "Jev", en: "Jev", sq: "Jev" },

    /* ===== Jev ===== */
    "jev.titre":         { fr: "Jev — décisions à la minute", en: "Jev — one-minute decisions", sq: "Jev — vendime çdo minutë" },
    "jev.compte":        { fr: "{n} entrées proposées", en: "{n} entries proposed", sq: "{n} hyrje të propozuara" },
    "jev.aucune":        { fr: "Aucune décision encore : Jev attend la première bougie close.", en: "No decision yet: Jev is waiting for the first closed candle.", sq: "Ende asnjë vendim: Jev pret qirinin e parë të mbyllur." },
    "jev.mode.observation": { fr: "observation — aucun ordre", en: "observation — no orders", sq: "vëzhgim — pa urdhra" },
    "jev.mode.demo":     { fr: "démo OKX — faux argent", en: "OKX demo — paper money", sq: "demo OKX — para të rreme" },
    "jev.mode.reel":     { fr: "RÉEL", en: "LIVE", sq: "REAL" },
    "jev.mode.inactif":  { fr: "inactif", en: "inactive", sq: "joaktiv" },
    "jev.horizon":       { fr: "horizon", en: "horizon", sq: "horizonti" },
    "jev.appels":        { fr: "appels", en: "calls", sq: "thirrje" },
    "jev.reponses":      { fr: "réponses", en: "answers", sq: "përgjigje" },
    "jev.erreurs":       { fr: "échecs", en: "failures", sq: "dështime" },
    "jev.tardives":      { fr: "tardives", en: "late", sq: "të vonuara" },
    "jev.latence":       { fr: "latence p50 / p95", en: "latency p50 / p95", sq: "vonesa p50 / p95" },
    "jev.cout":          { fr: "coût du jour", en: "today’s cost", sq: "kostoja e ditës" },
    "jev.flux":          { fr: "instruments suivis", en: "instruments followed", sq: "instrumente të ndjekura" },
    "jev.fluxmuet":      { fr: "flux muet depuis {s} s", en: "feed silent for {s} s", sq: "rrjedha e heshtur prej {s} s" },
    "jev.verdict":       { fr: "verdict du banc", en: "bench verdict", sq: "verdikti i stolit" },
    "jev.verdict.oui":   { fr: "réel autorisé", en: "live authorised", sq: "reali i autorizuar" },
    "jev.verdict.non":   { fr: "réel refusé", en: "live refused", sq: "reali i refuzuar" },
    "jev.verdict.aucun": { fr: "aucun verdict", en: "no verdict", sq: "asnjë verdikt" },
    "jev.coupe":         { fr: "coupe-circuit", en: "circuit breaker", sq: "ndërprerësi" },
    "jev.coupe.ferme":   { fr: "fermé · perte du jour {p} % / {s} %", en: "closed · today’s loss {p} % / {s} %", sq: "i mbyllur · humbja e ditës {p} % / {s} %" },
    "jev.coupe.ouvert":  { fr: "OUVERT — plus d’entrée aujourd’hui", en: "OPEN — no more entries today", sq: "I HAPUR — pa hyrje të tjera sot" },
    "jev.questions":     { fr: "questions", en: "questions", sq: "pyetjet" },
    "jev.depasse":       { fr: "dépasse le coût", en: "beats cost", sq: "kalon koston" },
    "jev.conviction":    { fr: "conviction", en: "conviction", sq: "bindja" },
    ...
    "sante.d.coupeCircuit": { fr: "Plus aucune entrée après X % de perte dans la journée UTC. Se referme au changement de jour, jamais sur un rebond.", en: "No more entries after X % loss in the UTC day. Resets at the day change, never on a bounce.", sq: "Pa hyrje të tjera pas X % humbje brenda ditës UTC. Rihapet me ndërrimin e ditës, kurrë me një kërcim." },
    "sante.d.jev":       { fr: "Le décideur Jev : une décision par bougie 1 min close, ses appels, sa latence et son coût.", en: "The Jev decider: one decision per closed 1-minute candle, its calls, latency and cost.", sq: "Vendimmarrësi Jev: një vendim për çdo qiri 1-minutësh të mbyllur, thirrjet, vonesa dhe kostoja." },
