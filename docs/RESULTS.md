...
## 12. Essais du 23 septembre : V2 n'aide pas

| | `sres` corrigé (papier) | V2 : funding 8 h, 300 arbres, poids égaux |
|---|---:|---:|
| IC (t) | 0,045 (8,3) | 0,047 (9,1) |
| Sharpe net / CAGR | **1,10** / **+12,6 %** | 0,82 / +8,4 % |
| Drawdown max | −11,0 % | −12,3 % |
| 2024 / 2025 / 2026 | +12,4 / +36,7 / −6,8 % | +9,9 / +25,9 / −8,3 % |
| DSR / PBO / coûts ×2 | 0,46 / 0,38 / 0,64 | 0,25 / **0,10** / −0,01 |
...
modèle de direction du marché (un quatrième changement, sans effet sur la porte). Le modèle en papier reste
`sres`. En cours : la garde de régime (V1) et le positionnement des gros comptes.
