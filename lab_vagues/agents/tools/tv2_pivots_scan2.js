// SCAN "CAMARILLA H3/L3" (agent tv2_pivots_, Pack PIVOTS, 31/08) — niveaux de FADE réputés
// (méthode Nick Scott 1989, formule EXACTE TradingView "Camarilla Pivot Points" communautaire) :
//   H3 = Cveille + (Hveille - Lveille) * 1.1/4      L3 = Cveille - (Hveille - Lveille) * 1.1/4
// calculés sur le jour UTC CALENDAIRE PRÉCÉDENT (100% causal, cf. tv2_pivots_lib.js). H3/L3 sont
// la paire de niveaux la plus utilisée par les day-traders Camarilla pour FADER un excès intraday
// (H4/L4, plus larges, servent au breakout — hors-scope ici, non demandés).
// mode X = rejet même bougie (mèche qui perce H3/L3, clôture qui referme dedans)
// mode R = reclaim (clôture était dehors au i-1, revient dedans au i, niveau stable entre i-1/i).
// H3 = résistance pure (fade SHORT), L3 = support pur (fade LONG).
const fs = require("fs");
...
const out = path.join(__dirname, "tv2_pivots_scan2_resultats.json");
