// GÉNÉRALISATION DU FILTRE DE RÉGIME : mèche d'épuisement 5m (mèche >= 60 % du range + volume >= 1,5x SMA20)
// fadée UNIQUEMENT dans la moitié favorable du range 24h. Sans filtre MEGA est PERDANTE (worst = -1,23,
// invalide) -> filtrée worst = +6,22 (OOS +8,49) : le filtre transforme un signal mort en edge.
module.exports = {
