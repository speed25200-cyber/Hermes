// LINEA : UT Bot Alerts (QuantNomad, code exact, option Heikin Ashi) fadé — même logique que
// tv_luxalgo_1 (flip du stop suiveur ATR = prise de stops -> contre-sens), réglage plus nerveux
// a=3 × ATR5 pour une L2 liquide. Robustesse : tout le voisinage a2/a3/a4 × c5-c30 worst > 0
// (les cases voisines ne manquent la validité que par n<60, jamais par esp négative).
const A = 3, C = 5;
