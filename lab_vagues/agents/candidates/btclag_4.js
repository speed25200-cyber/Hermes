// KAITO : BTC lead-lag — fade de l'excès relatif au BTC (signal cross-asset, famille btclag_).
// Logique : excès = rendement log KAITO sur 2 h − β×rendement log BTC sur 2 h (β = régression
// des rendements 5 m sur 24 h glissantes) ; z-score de l'excès sur 24 h passées ; au
// FRANCHISSEMENT de ±2 (zx : 1re bougie au-delà du seuil) → fade immédiat de l'excès.
// Robustesse : zx/T2/H24 E1 → B288 6,12 / B576 4,61 (les 2 valides) ; ⚠️ le mode zr est
// négatif à H24 sur KAITO (famille mode-sensible, la plus fragile des 4 retenues). Exit E1.
const fs = require("fs");
const path = require("path");
const B = 288, H = 24, W = 288, T = 2;
