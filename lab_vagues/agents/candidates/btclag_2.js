// FARTCOIN : BTC lead-lag — fade de l'excès relatif au BTC (signal cross-asset, famille btclag_).
// Logique : excès = rendement log FARTCOIN sur 1 h − β×rendement log BTC sur 1 h (β = régression
// des rendements 5 m sur 24 h glissantes) ; z-score de l'excès sur 24 h passées ; quand le
// z RECLAIM (repasse sous +2 après excès, encore positif) → short l'excès, symétrique long.
// Robustesse : zr/T2 E1 → H12 : B288 6,89 / B576 5,36 (valides), H48 : 2,40/4,14 positifs.
// Bat le champion FARTCOIN en place (web_structure_4 sweep, worst 5,48). Exit fondateur E1.
const fs = require("fs");
const path = require("path");
const B = 288, H = 12, W = 288, T = 2;
