...
// moitié favorable de son range 24h (long en moitié basse, short en moitié haute).
// Preuve que le filtre ajoute : STABLE nu (mêmes exits) worst=+4,53 % -> filtré worst=+6,42 %.
module.exports = {
