// TEMPO-ASYM (asymétrie de tempo sur zigzag adaptatif) — KMNO (Kamino, DeFi Solana)
// L'indicateur : un zigzag CAUSAL dont le seuil de retournement s'adapte à la crypto
// (X_i = 2 × SMA288(|rendement 5m|), borné [0,2 %, 6 %]) découpe le prix en « jambes » ;
// sur les 6 dernières jambes finies on compare le TEMPS passé à monter au temps passé à descendre.
// Lecture : si le marché a passé >= 2× plus de temps à monter qu'à descendre et qu'une jambe de
// baisse (éclair, par construction) vient d'être confirmée -> LONG, la baisse rapide n'était
// qu'une purge dans un tempo haussier intact ; miroir en short. Signal à la bougie de CONFIRMATION
// du pivot (retrace X constaté sur clôture close) — zéro look-ahead.
const K = 2;        // seuil zigzag en unités de vol propre
