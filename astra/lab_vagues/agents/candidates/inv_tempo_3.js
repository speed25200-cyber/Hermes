// TEMPO-ASYM (asymétrie de tempo sur zigzag adaptatif) — SPK (Spark, DeFi)
...
// Lecture : si le marché a passé >= 1,5× plus de temps à monter qu'à descendre et qu'une jambe de
...
const R = 1.5;        // asymétrie de tempo requise (1,5:1)
