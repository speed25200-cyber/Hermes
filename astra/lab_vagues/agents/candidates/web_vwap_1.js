// SOON : reclaim de bande VWAP session (ancre jour UTC, bandes = écart-type pondéré volume).
// Doc web : fade de la bande ±2σ UNIQUEMENT quand la bougie referme À L'INTÉRIEUR (reclaim),
// jamais pendant l'excursion — évite de contrer un trend day. Warm-up 3 h de session.
module.exports = {
