// GÉNÉRALISATION DU FILTRE DE RÉGIME : mèche d'épuisement 5m (mèche >= 60 % du range + volume >= 2x SMA20)
// fadée UNIQUEMENT dans la moitié favorable du range 24h.
// Preuve que le filtre ajoute : GPS nu (mêmes exits) worst = +5,32 -> filtré worst = +6,19 (OOS +11,36).
module.exports = {
