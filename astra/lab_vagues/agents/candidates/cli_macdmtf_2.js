...
// Même famille que cli_macdmtf_1.js (KGEN), variante de seuils/période RSI ; le plateau est confirmé :
// contra survit avec les 2 jeux de sorties (tp80/hold12 ET tp60/hold24) sur cette crypto.
module.exports = {
